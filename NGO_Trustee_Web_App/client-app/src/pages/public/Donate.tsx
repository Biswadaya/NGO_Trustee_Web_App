        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <Card className="bg-white border-slate-200 shadow-sm">
              <CardHeader>
                <CardTitle className="text-xl text-slate-900">Make a Donation</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <Label className="block text-slate-700">Your Details</Label>
                  <Input placeholder="Full Name" className="border-slate-200 bg-slate-50 text-slate-900" />
                  <Input placeholder="Email Address" type="email" className="border-slate-200 bg-slate-50 text-slate-900" />
                  <Input placeholder="Phone Number" className="border-slate-200 bg-slate-50 text-slate-900" />
                  <Input placeholder="PAN Number (for 80G receipt)" className="border-slate-200 bg-slate-50 text-slate-900" />
                </div>
                ...
                <Button size="xl" className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold">
                  Donate ₹{amount || '0'}
