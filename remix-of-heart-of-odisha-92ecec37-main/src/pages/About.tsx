      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">{t('about.teamSubtitle')}</p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { key: 'chairman', initials: 'BP' },
              { key: 'viceChairman', initials: 'RS' },
              { key: 'secretary1', initials: 'PN' },
              { key: 'secretary2', initials: 'SD' },
              { key: 'treasurer', initials: 'GM' },
            ].map((member, index) => (
              <motion.div
                key={member.key}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                ...
                <h3 className="text-lg font-bold text-foreground">{t(`about.team.${member.key}.name`)}</h3>
                <p className="text-sm text-primary font-medium mb-2">{t(`about.team.${member.key}.role`)}</p>
                <p className="text-sm text-muted-foreground">{t(`about.team.${member.key}.description`)}</p>
              </motion.div>
            ))}
          </div>
        </div>
