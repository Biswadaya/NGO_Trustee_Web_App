...
const Programs = () => {
  ...
  const programs = [
    ...
    },
    {
      ...
      features: [t('programs.features.emergencyRelief', 'Emergency relief'), t('programs.features.foodDistribution', 'Food distribution'), t('programs.features.shelterSupport', 'Shelter support'), t('programs.features.covidResponse', 'COVID response'), t('programs.features.communityResilience', 'Community resilience')],
              ...
              >
                ...
                <div className="flex-1 space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold text-foreground">{t(program.titleKey)}</h2>
                  </div>
