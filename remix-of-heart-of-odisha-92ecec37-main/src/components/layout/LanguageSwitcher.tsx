  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors touch-target ${
            isTransparent
        ...
        {languages.map((lang) => (
          <DropdownMenuItem
            ...
            className={`cursor-pointer gap-2 ${
              currentLang === lang.code ? 'bg-primary text-primary-foreground' : ''
            }`}
          >
